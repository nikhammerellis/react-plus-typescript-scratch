...
class Cart extends React.Component<Props, State> {
    ...
    handleOutsideClick = (e: MouseEvent) => {
        //make sure the cart wasn't what was clicked 
    ...
    componentDidMount() {
        //we want to close the cart if we click outside of it, but leave open if we click it 
                ...
                {(state) => {
                    ...
                    return (
                        <div className={CartCSS.cartContainer} ref={this.#containerRef}>
                            ...
                            <div className={CartCSS.cartDropDown} style={{ display: this.state.isOpen === true ? 'block' : 'none' }}>
                                <ul>
